<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="text-center py-12">
      <h2 class="text-2xl font-semibold text-gray-900 mb-4">Order History Coming Soon</h2>
      <p class="text-gray-500 mb-8">Order history functionality is under development.</p>
      <router-link
        to="/"
